...
}`;async function ie(e){await(0,M.promisify)(L.exec)(`open -g "${e}"`)}function oe(e){return F.stringify(e,{skipNull:!0,skipEmptyString:!0})}async function W(e){await ie(`things:///add?${oe(e)}`)}async function ce(e){return await W(e)}
