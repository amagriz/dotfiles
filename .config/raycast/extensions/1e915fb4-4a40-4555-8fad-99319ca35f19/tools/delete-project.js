...
`);return e?e.originalMessage=e.message:e=l,e.message=y,e.shortMessage=g,e.command=s,e.exitCode=n,e.signal=a,e.stdout=r,e.stderr=t,"bufferedData"in e&&delete e.bufferedData,e}function ie({stdout:r,stderr:t,error:e,exitCode:a,signal:n,timedOut:s,command:i,options:c,parentError:l}){if(e||a!==0||n!==null)throw se({error:e,exitCode:a,signal:n,stdout:r,stderr:t,command:i,timedOut:s,options:c,parentError:l});return r}async function D(r,t,e){if(process.platform!=="darwin")throw new Error("AppleScript is only supported on macOS");let{humanReadableOutput:a,language:n,timeout:s,...i}=Array.isArray(t)?e||{}:t||{},c=a!==!1?[]:["-ss"];n==="JavaScript"&&c.push("-l","JavaScript"),Array.isArray(t)&&c.push("-",...t);let l=U.default.spawn("osascript",c,{...i,env:{PATH:"/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"}}),u=ee(l,{timeout:s??1e4});l.stdin.end(r);let[{error:p,exitCode:g,signal:y,timedOut:z},V,F]=await re(l,{encoding:"utf8"},u),B=_({stripFinalNewline:!0},V),G=_({stripFinalNewline:!0},F);return ie({stdout:B,stderr:G,error:p,exitCode:g,signal:y,timedOut:z,command:"osascript",options:e,parentError:new Error})}var L=(0,m.getPreferenceValues)(),d=class extends Error{constructor(e,a,n,s){super(s?`${s}: ${e}`:e);this.type=a;this.originalError=n;this.operation=s;this.name="ThingsError"}},N=async(r,t)=>{try{let e=await D(`(function(){${r}})()`,{humanReadableOutput:!1,language:"JavaScript",timeout:6e4});return e?JSON.parse(e.replace(/:\s*undefined/g,": null")):void 0}catch(e){let n=(typeof e=="string"?e:e instanceof Error?e.message:String(e)).replace("execution error: Error: ","");throw n.match(/Application can't be found/i)?new d("Things application not found. Please make sure Things is installed and running.","APP_NOT_FOUND",n,t):n.match(/not allowed assistive access/i)||n.match(/permission/i)||n.match(/-1743/)?new d("Permission denied. Please grant Raycast access to Things in System Settings > Privacy & Security > Automation > Raycast > Things.","PERMISSION_DENIED",n,t):n.match(/doesn't understand/i)||n.match(/can't get/i)?new d("Things automation interface error. This might be due to a Things version incompatibility or the app not being ready.","EXECUTION_ERROR",n,t):n.match(/timed out/i)?new d("Command timed out. Things may be unresponsive or not running.","EXECUTION_ERROR",n,t):new d(`Unexpected error: ${n}`,"UNKNOWN_ERROR",n,t)}};var M=r=>N(`
  ...
  const project = things.projects.byId('${r}')

  return project.name();
`,"Get project name");var W=r=>N(`
  const things = Application('${L.thingsAppIdentifier}');
  things.delete(things.projects.byId('${r}'));
`,"Delete project");var oe=`todo => {
...
}`;async function le({projectId:r}){return await W(r)}var ue=async({projectId:r})=>({message:"Are you sure you want to delete the project?",info:[{name:"Project",value:await M(r)}]});0&&(module.exports={confirmation});
